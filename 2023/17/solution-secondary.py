...
def solution(lines):
    ...
    def valid_moves(state):
        ...
        moves = []
        for delta in DIRS:
            if direc != (0, 0) and direc != delta and repeat < 4:
                continue
            if direc == delta and repeat == 10:
                continue
    ...
    leastloss = min(cost for (point, _, repeat), cost in costs.items() if point == finaldest and repeat >= 4)
